...
| `OPENF1_USERNAME` / `OPENF1_PASSWORD` | — | Cuenta de OpenF1 (openf1.org). OpenF1 ahora exige **cuenta de pago para datos en tiempo real** (la sesión en curso, desde 30 min antes hasta 30 min después); los datos históricos siguen gratis. Sin cuenta: el calendario cae solo al respaldo gratis de Jolpica y la telemetría en vivo puede no estar disponible (queda la narración por visión) |
